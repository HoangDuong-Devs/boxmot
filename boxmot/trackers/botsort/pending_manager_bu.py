...
class PendingManager:
    def __init__(self, kalman_filter, min_lost_matches_to_promote=3, promotion_deadline=30,
                ...
                use_qdrant_server=False, qdrant_group_provider=None):
        self.pending_tracks = []
        self.kalman_filter  = kalman_filter
        self.min_lost_matches_to_promote = min_lost_matches_to_promote
        self.promotion_deadline = promotion_deadline
            ...
            try:
                ...
                for ipend, ilost in pairs:
                    try:
                        ...
                        c = float(cost_l[ipend, ilost])  # cost theo feature (0..1)
    ...
    def _summarize_cand_lost(self, p):
        try:
            ...
            # Ví dụ: "id=6(fr=9), id=3(fr=5)"
            parts = [f"id={lid}(fr={st.get('frames',0)})" for lid, st in cl.items()]
